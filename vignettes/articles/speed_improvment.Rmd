...
At very high-resolution data (> 600 points in the normalized range), the execution time for `sdar_lazy()` seems to stabilize to a (more or less) constant value of 1.8 seconds (when using four cores) to 3 seconds (when using only one or eight cores).
