...
The execution time of the different algorithms over the number of points in the normalized range is given in the next figure.

```{r plot benchmarking result, warning=FALSE, message=FALSE, results='asis'}
