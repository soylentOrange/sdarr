...
# setup multi-session calculations with a maximum of 8 cores
...
A basic example of `sdar.lazy()`, a random sub-sampling modification of the SDAR-algorithm on a synthetic data set, which is based on the properties of aluminium (EN AW-6060-T66).
...
To make use of multi-core processing, configure [furrr](https://furrr.futureverse.org/) to use a multi-session strategy (see above).
