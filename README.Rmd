...
As the SDAR-algorithm, implemented in `sdarr()`, heavily uses linear regressions, a faster version `sdarr.lazy()` was implemented, which finds the optimum region for linear fitting by random sub-sampling.
